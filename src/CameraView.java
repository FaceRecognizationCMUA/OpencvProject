...
/**
 * CameraView class is a class for GUI that display images generated by camera()
     ...
     */
     ...
     public void paintComponent(Graphics g){  
          ...
          if (this.image==null) return;         
           g.drawImage(this.image,10,10,this.image.getWidth(),this.image.getHeight(), null);//draw image from table
     }
...
/**
 * This action handler is to control the camera in Main.camera();
 * @param evt 
 */
